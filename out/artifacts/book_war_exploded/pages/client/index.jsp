        ...
        $(function () {
            $("button.addToCart").click(function () {
                ...
                $.getJSON("http://localhost:8080/book/cartServlet", "action=ajaxAddItem&id=" + bookId, function (data) {
                    ...
                    $("#cartLastName").text("您刚刚将 " + data.lastName + " 加入到购物车"); 
                })
            });
...
<div id="header">
    ...
    <span class="wel_word" style="font-family: 华文琥珀; color: red">网上购书中心</span>
    <div>
    ...
    <div id="book">
        ...
        <div style="text-align: center">
            ...
            <c:if test="${not empty sessionScope.cart.items}">
                ...
                <div>
                    <span id="cartLastName">您刚刚将 ${sessionScope.lastName} 加入到购物车</span>
                </div>
            </c:if>
